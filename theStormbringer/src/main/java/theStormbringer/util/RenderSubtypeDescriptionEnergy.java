...
public class RenderSubtypeDescriptionEnergy {
    @SpirePatch(
    ...
    public static class RenderTypeEnergy {
        ...
        public static void Insert(AbstractCard __instance, SpriteBatch sb,
            ...
            if (tmp[0].length() > 0 && tmp[0].charAt(0) == '[') {
                ...
                if (StormbringerMod.TypeEnergyAtlas.findRegion(key) != null) {
                    gl.width = CARD_ENERGY_IMG_WIDTH * __instance.drawScale;
                    renderTypeEnergy(__instance, sb, StormbringerMod.TypeEnergyAtlas.findRegion(key),
            ...
            if (tmp[0].length() > 0 && tmp[0].charAt(0) == '[') {
                ...
                if (StormbringerMod.TypeEnergyAtlas.findRegion(key) != null) {
                    ...
                    try {
                        ...
                        renderSmallEnergy.invoke(__instance, sb, StormbringerMod.TypeEnergyAtlas.findRegion(key),
