...
public class PlaceholderPotion extends CustomPotion {
    ...
    public static final String POTION_ID = theStormbringer.StormbringerMod.makeID("PlaceholderPotion");
    ...
    public PlaceholderPotion() {
        // The bottle shape and inside is determined by potion size and color. The actual colors are the main StormbringerMod.java
